...
public class SelecionaPragaPlanosRealizados extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout= findViewById(R.id.drawer_layout_SPPR);
        NavigationView navigationView = findViewById(R.id.nav_view_SPPR);
        ...
        ConnectionBuddy.getInstance().registerForConnectivityEvents(this, new ConnectivityChangeListener() {
            ...
            public void onConnectionChange(ConnectivityEvent event) {
                ...
                if(!u.isConected(getBaseContext()))
                {
                    ...
                    final Controller_PlanoAmostragem cpa = new Controller_PlanoAmostragem(SelecionaPragaPlanosRealizados.this);
                    final Controller_PresencaPraga cpp = new Controller_PresencaPraga(SelecionaPragaPlanosRealizados.this);
    ...
    public void SalvarPlanos(PlanoAmostragemModel pam){
        Controller_Usuario cu = new Controller_Usuario(SelecionaPragaPlanosRealizados.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(SelecionaPragaPlanosRealizados.this);
