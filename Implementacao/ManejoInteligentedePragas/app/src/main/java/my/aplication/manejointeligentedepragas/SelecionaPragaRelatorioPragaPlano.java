...
public class SelecionaPragaRelatorioPragaPlano extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //menu novo
        Toolbar toolbar = findViewById(R.id.toolbar_SPRPP);
        setSupportActionBar(toolbar);
        drawerLayout= findViewById(R.id.drawer_layout_SPRPP);
        NavigationView navigationView = findViewById(R.id.nav_view_SPRPP);
        ...
        ConnectionBuddy.getInstance().registerForConnectivityEvents(this, new ConnectivityChangeListener() {
            ...
            public void onConnectionChange(ConnectivityEvent event) {
                ...
                if(!u.isConected(getBaseContext()))
                {
                    ...
                    final Controller_PlanoAmostragem cpa = new Controller_PlanoAmostragem(SelecionaPragaRelatorioPragaPlano.this);
                    final Controller_PresencaPraga cpp = new Controller_PresencaPraga(SelecionaPragaRelatorioPragaPlano.this);
    ...
    public void SalvarPlanos(PlanoAmostragemModel pam){
        Controller_Usuario cu = new Controller_Usuario(SelecionaPragaRelatorioPragaPlano.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(SelecionaPragaRelatorioPragaPlano.this);
