...
public class SobreMIP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setTitle("MIP² | Sobre o aplicativo");
        ...
        resposta7.setText("Ao selecionar a cultura onde se localiza a praga a ser amostrada clique em REALIZAR PLANO DE AMOSTRAGEM e selecione a praga. Siga as informações descritas na tela inspecionando o número de plantas exigido, caso tenha dúvida sobre onde observar a presença da praga (AMOSTRA) clique no botão (i). Você deverá inspecionar o número de plantas descrito para cada talhão, caso tenha menos plantas que o necessário, realize o plano de amostragem apenas com o número de plantas presentes em sua cultura. Para realizar a contagem clique no botão PRESENÇA ou AUSÊNCIA de acordo com a AMOSTRA para cada planta até completar o plano, se cometer um erro, é possível clicar em CORRIGIR, corrigindo a última planta amostrada, podendo também segurar o botão para recomeçar a contagem, caso tenha cometido erros consecutivos. Ao FINALIZAR a contagem você será levado para uma tela que vai informar se há necessidade de aplicar algum método de controle. Havendo necessidade, você poderá selecionar o método de controle, devendo aplicá-lo assim que possível. \n" +
        ...
        resposta8.setText("É indicado que, ao detectar a necessidade de uma aplicação, o usuário realize-a o quanto antes, aplicando sobre TODA a cultura e NÂO apenas sobre as plantas infestadas. Para mais informações leia a descrição do método a ser utilizado.");
