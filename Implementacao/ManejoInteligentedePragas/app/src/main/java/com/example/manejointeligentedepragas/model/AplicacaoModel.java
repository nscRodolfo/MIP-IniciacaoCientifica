...
public class AplicacaoModel {
    ...
    public AplicacaoModel(String Autor, int popPragas, int numPlantas, String DataPlano, String MetodoAplicado, int cod_Aplicacao, String data, String estacao, String temperatura, String tempo, int fk_Cod_MetodoControle, int fk_Cod_Cultura) {
